...
<div class="feature-grid">
  ...
  <div class="feature-card">
    <h3>🔒 Encrypted</h3>
    <p>Messages are encrypted end-to-end. Your conversations stay private even over shared radio frequencies.</p>
  </div>
  <div class="feature-card">
    <h3>💰 Affordable</h3>
  ...
  <div class="feature-card">
    <h3>🌍 Long Range</h3>
    <p>LoRa radios can reach 5–15+ miles line-of-sight. With relay nodes, coverage grows across the whole region.</p>
  </div>
  <div class="feature-card">
    <h3>⚡ Low Power</h3>
    <p>Devices run for days or weeks on a small battery. Deploy solar-powered fixed nodes for permanent coverage.</p>
  </div>
  <div class="feature-card">
